...
# zipkin()
jaeger()
# dapr("dev", "dapr-wt-dynamic-secrets")
# dapr("1.16.14")
# dapr("1.17.6")
dapr("1.18.1")
...
# load_dynamic('apps/actors-grpc-py/Tiltfile')
...
# load_dynamic('apps/bulk-pubsub/Tiltfile')
# load_dynamic('apps/workflows-go/Tiltfile')
# load_dynamic('apps/nginx-no-dapr/Tiltfile')
...
load_dynamic('apps/secrets-py/Tiltfile')
