...
def test_workflow(ctx: DaprWorkflowContext, wf_input: str):
    ...
    number1 = yield ctx.call_child_workflow("TestWorkflow2", app_id="workflows-crossapp2")
    logger.debug(f'Subworkflow completed. Number: {number1}')
...
def main():
    ...
    app_port = os.getenv('APP_PORT', 6010)
    # Start Flask server
